...
<div class="container mt-5 text-center center">
    <a href="index.php">
        <center><img src="images/untitled.png" class="img-fluid"></center>
    </a>
    <p><p>
    <form action="masuk-beranda.php" method="post">
        ...
        <div class="col-sm-3 mt-3 center">
            <input type="text" class="form-control" name="penggunaID" placeholder="Masukkan Nomor ID" required=""
                   id="inputBox">
        </div>
        <div class="col-sm-3 mt-3 center">
...
<div class="footer">
    <p>© 2023 Database System | Kelompok PBW</p>
</div>
